...
* Fixing the email sending to make it work to allow the user to reset their password
* Make the text more readable
* Centering the text to have everything aligned with each other
* Changing the design of the website to make it look nicer and user friendly
